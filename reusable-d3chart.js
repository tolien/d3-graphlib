        ...
        selection.each(function(data) {
            ...
            data.map(function(d, i) {
                ...
                if (legendItems[i] && legend.node()) {
                    ...
                    legendEntry.attr("transform", "translate(" + i * (legend.node()
                        .getBBox()
                        .width + 10) + ", 0)");
            ...
            if (legend && legend.node()) {
                var legendTranslation = width - margin.left - margin.right - legend.node()
                    .getBBox()
                    .width;
